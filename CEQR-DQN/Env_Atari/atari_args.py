...
class Args:
    ...
    log_folders: list[str] = field(default_factory=lambda: ["MinAtar-Asterix-CEQRDQN","MinAtar-Breakout-CEQRDQN","MinAtar-Freeway-CEQRDQN","MinAtar-Seaquest-CEQRDQN","MinAtar-SpaceInvaders-CEQRDQN"])
    """log folder names"""
    game_idx: int = 0
