...
class Args:
    ...
    notes: str = "PER-CEQRDQN"
    """notes regarding the run"""
    wandb_entity: str = "exploruder"
    """the entity (team) of wandb's project"""
    wandb_project: str = "PER-CEQRDQN"
    """the wandb's project name"""
    wandb_group: str = "_PER-CEQRDQN"
    ...
    env_ids: list[str] = field(default_factory=lambda: ["CartPole-v1", "Acrobot-v1", "LunarLander-v2", "MountainCar-v0"])
    """the name of the game environment (default: CartPole-v1)"""
    log_folders: list[str] = field(default_factory=lambda: ["Gym-CartPole-PER-CEQRDQN", "Gym-Acrobot-PER-CEQRDQN", "Gym-LunarLander-PER-CEQRDQN", "Gym-MountainCar-PER-CEQRDQN"])
    """log folder names"""
    game_idx: int = 0
    ...
    obs_space_chs: list[int] = field(default_factory=lambda: [4, 6, 8, 2])
    ...
    evi_coeffs: list[float] = field(default_factory=lambda: [0.5, 0.5, 0.5, 0.5])
    """evidential coefficient for the regularization loss"""
    unc_lambdas_ep: list[float] = field(default_factory=lambda: [0.02, 0.001, 0.001, 0.001])
    """lambda for epistemic uncertainty for Thompson sampling"""
    unc_lambdas_al: list[float] = field(default_factory=lambda: [0, 0, 0, 0])
