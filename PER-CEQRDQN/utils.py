...
def quantile_huber_loss(x,y, device, kappa=1):
    ...
    return quantile_loss.mean(2) # torch.Size([32, 20])
...
def gamma_cal_loss(gamma,y,lamda,device):
    ...
    gcal_loss = interval_loss + calibrationloss
    return gcal_loss # torch.Size([32, 20])
