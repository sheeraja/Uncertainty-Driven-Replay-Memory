...
class Args:
    ...
    wandb_project: str = "PERCEQRDQN"
    """the wandb's project name"""
    wandb_group: str = "_PERCEQRDQN"
    ...
    log_folders: list[str] = field(default_factory=lambda: ["Gym-FrozenLake-PER-CEQRDQN", "Gym-CliffWalking-PER-CEQRDQN"])
    """log folder names"""
    game_idx: int = 0
