...
class Args:
    ...
    env_ids: list[str] = field(default_factory=lambda: ['MinAtar/Asterix-v1','MinAtar/Breakout-v1','MinAtar/Freeway-v1','MinAtar/Seaquest-v1','MinAtar/SpaceInvaders-v1'])
    """the names of the game environments"""
    log_folders: list[str] = field(default_factory=lambda: ["MinAtar-Asterix-UDRM","MinAtar-Breakout-UDRM","MinAtar-Freeway-UDRM","MinAtar-Seaquest-UDRM","MinAtar-SpaceInvaders-UDRM"])
    """log folder names"""
    game_idx: int = 0
    ...
    alpha: int = 50
    """alpha recalibration interval"""
    beta: int = 5000
    """beta recalibration interval"""
    kappa: int = 1
    ...
    unc_lambdas_ep: list[float] = field(default_factory=lambda: [0.001, 0.01, 0.0002, 0.005, 0.0005])
