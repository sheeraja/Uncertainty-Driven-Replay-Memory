...
class Args:
    ...
    log_folders: list[str] = field(default_factory=lambda: ["Gym-CartPole-UADQN", "Gym-Acrobot-UADQN", "Gym-LunarLander-UADQN", "Gym-MountainCar-UADQN"])
    """log folder names"""
    game_idx: int = 0
    ...
    weight_scale: list[float] = field(default_factory=lambda: [3, 3, 3, 3])  
    """the scale of the weight noise for CNNMinAtar"""
    noise_scale: list[float] = field(default_factory=lambda: [1, 1, 1, 1])
